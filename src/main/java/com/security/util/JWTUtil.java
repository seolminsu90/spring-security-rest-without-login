...
public class JWTUtil {
    ...
    public String createToken(UserDetailsDTO user, String ip_address) {
        ...
        String accessToken = Jwts.builder().setHeaderParam("type", "app-access-key")
                .setHeaderParam("issueDate", System.currentTimeMillis()).setHeaderParam("ip", ip_address)
                .setClaims(claims).setExpiration(dt).signWith(SignatureAlgorithm.HS512, "SIGN_KEY_HERE").compact();
        return accessToken;
    }
